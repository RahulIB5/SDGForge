...
//   const [form, setForm] = useState<FIRFormData>({
//     complainantName: "",
//     email: "",
//     gender: "",
//     urgencyLevel: "",
...
//     setMessage("");
//     try {
//       const res = await axios.post("http://localhost:8000/fir/fir", form);
...
//       <h2 className="text-2xl font-bold mb-4">FIR Submission Form</h2>

//       {/* Personal Details */}
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//         <div>
//           <label className="block">Name</label>
//           <input name="complainantName" value={form.complainantName} onChange={handleChange} required className="w-full border p-2 rounded" />
//         </div>
//         <div>
...
//           <input name="fatherName" value={form.fatherName || ""} onChange={handleChange} className="w-full border p-2 rounded" />
//         </div>
//         <div>
//           <label className="block">Age</label>
//           <input type="number" name="age" value={form.age || ""} onChange={handleChange} className="w-full border p-2 rounded" />
//         </div>
//         <div>
...
//           <input name="occupation" value={form.occupation || ""} onChange={handleChange} className="w-full border p-2 rounded" />
//         </div>
//         <div>
...
//           <input name="state" value={form.state || ""} onChange={handleChange} className="w-full border p-2 rounded" />
//         </div>
//       </div>
...
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//         <div>
//           <label className="block">Incident Date</label>
//           <input type="date" name="incidentDate" value={form.incidentDate || ""} onChange={handleChange} className="w-full border p-2 rounded" />
//         </div>
//         <div>
//           <label className="block">Incident Time</label>
//           <input type="time" name="incidentTime" value={form.incidentTime || ""} onChange={handleChange} className="w-full border p-2 rounded" />
//         </div>
//         <div>
//           <label className="block">Incident Location</label>
//           <input name="incidentLocation" value={form.incidentLocation || ""} onChange={handleChange} className="w-full border p-2 rounded" />
//         </div>
//         <div>
//           <label className="block">Crime Type</label>
//           <input name="crimeType" value={form.crimeType || ""} onChange={handleChange} className="w-full border p-2 rounded" />
//         </div>
//         <div className="md:col-span-2">
//           <label className="block">Incident Description</label>
//           <textarea name="incidentDescription" value={form.incidentDescription || ""} onChange={handleChange} className="w-full border p-2 rounded"></textarea>
//         </div>
//         <div>
//           <label className="block">Urgency Level</label>
//           <select name="urgencyLevel" value={form.urgencyLevel} onChange={handleChange} className="w-full border p-2 rounded">
//             <option value="">Select</option>
...
//         </div>
//         <div className="md:col-span-2">
//           <label className="block">Witness Details</label>
//           <textarea name="witnessDetails" value={form.witnessDetails || ""} onChange={handleChange} className="w-full border p-2 rounded"></textarea>
//         </div>
//         <div className="md:col-span-2">
//           <label className="block">Evidence Details</label>
//           <textarea name="evidenceDetails" value={form.evidenceDetails || ""} onChange={handleChange} className="w-full border p-2 rounded"></textarea>
//         </div>
//         <div>
//           <label className="flex items-center">
//             <input type="checkbox" name="previousComplaint" checked={form.previousComplaint || false} onChange={handleChange} className="mr-2" />
//             Previous Complaint?
//           </label>
//         </div>
//         {form.previousComplaint && (
//           <div className="md:col-span-2">
//             <label className="block">Previous Complaint Details</label>
//             <textarea name="previousComplaintDetails" value={form.previousComplaintDetails || ""} onChange={handleChange} className="w-full border p-2 rounded"></textarea>
//           </div>
//         )}
//       </div>
...
export default function FIRComplaintForm() {
  ...
  const handleSubmit = async () => {
    ...
    setSubmitMessage('');
    try {
      const response = await axios.post('http://localhost:8000/fir/fir', formData);
      setSubmitMessage(response.data.message || 'FIR submitted successfully! You will receive a confirmation email shortly.');
      ...
      setSubmitMessage(error.response?.data?.detail || 'There was an error submitting your form. Please try again.');
    } finally {
      setIsSubmitting(false);
    }
  };
